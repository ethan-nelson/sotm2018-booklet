...
Source code: https://github.com/osmfoundation/sotm2018-booklet\\
...
Metro map: user Arbalete at Wikimedia Commons, CC-BY-SA 4.0
...
\begin{minipage}[hbtp]{0.74\textwidth}\RaggedRight
  {\small
    ...
    This does not apply to the metro map and advertisements and logos.
  }
\end{minipage}
