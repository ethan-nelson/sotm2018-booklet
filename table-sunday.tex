...
\noindent\begin{landscape}
  ...
  \noindent\begin{center}
    \noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{1.9cm}Z{3.5cm}Z{2.0cm}}
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Coordinating improved communication between the academic and OpenStreetMap communities}{Peter Mooney, Joost Schouppe, Frank Ostermann}
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Slum health mapping as catalyst for a collaborative agenda for research, practice, local citizens and volunteers}{João Porto de Albuquerque, Godwin Yeboah, Vangelis Pitidis, Philipp Ulbrich}
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Intrinsic assessment of the temporal accuracy, up-to-dateness, lineage and thematic accuracy of OpenStreetMap}{Francesco Frassinelli, Marco Minghini, Maria Antonia Brovelli}
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Comprehensive OpenStreetMap History Data Analyses- for and with the OSM community}{Michael Auer, Melanie Eckle, Sascha Fendrich, Fabian Kowatsch, Sabrina Marx, Martin Raifer, Moritz Schott, Rafael Troilo, Alexander Zipf}
      &
      \tabularnewline
      \rowcolor{commongray}
      13:00
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{An innovative approach to support OSM data generation}{Emanuela Mihut, Lucian Dragut, Mariana Belgiu}
      ...
      \talk{Investigating the OSM mapping process after disasters: OsmEventAnalyst and its application for the 2016 Italian earthquakes}{Luca Delucchi, Marco Minghini}
      &
      \tabularnewline
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{The challenges and issues associated with a natural resource mapping framework based upon OpenStreetMap}{Chris Emberson, Chris Hill, Gemma Gubbins, Andrew Harfoot}
      ...
      \talk{Using OpenStreetMap to model bicycle traffic in an agent-based transport simulation}{Dominik Ziemke, Simon Metzler}
      &
      \tabularnewline
    \end{tabular}
  \end{center}
