...
\noindent\begin{landscape}
  ...
  \noindent\begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Slum health mapping as catalyst for a collaborative agenda for research, practice, local~\dots}{João Porto de Albuquerque et\,al.}
  ...
  \begin{center}
    ...
    %\noindent\begin{tabular}{Z{0.75cm}Z{2.0cm}Z{2.0cm}Z{2.8cm}Z{2.0cm}}
      ...
      \talk{Intrinsic assessment of the temporal accuracy, up-to-dateness, lineage and thematic accuracy of OpenStreetMap}{Francesco Frassinelli et\,al.}
      ...
      \talk{Comprehensive OSM history data analyses---\linebreak for and with the OSM community}{Michael Auer et\,al.}
      &
    \end{tabular}
  \end{center}
  \begin{center}
